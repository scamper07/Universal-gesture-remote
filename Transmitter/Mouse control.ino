...
//Mouse control---->up1
  if(accelCount[0]<-200 && accelCount[0]>-350)
  {
    for(int i=0; i<3; i++)
    {
      irsend.sendSony(0xC94,12);
      delay(40);
    }
    readAccelData(accelCount);
  }
...
//Mouse control---->up2
  else if(accelCount[0]<-350)
  {
    for(int i=0; i<3; i++)
    {
      irsend.sendSony(0xC95,12);
      delay(40);
    }
    readAccelData(accelCount);
  }
...
//Mouse control---->down1
  else if(accelCount[0]>100 && accelCount[0]<200)
  {
    for(int i=0; i<3; i++)
    {
      irsend.sendSony(0xD94,12);
      delay(40);
    }
    readAccelData(accelCount);
  }
...
//Mouse control---->down2
  else if(accelCount[0]>200)
  {
    for(int i=0; i<3; i++)
    {
      irsend.sendSony(0xD95,12);
      delay(40);
    }
    readAccelData(accelCount);
  }
...
//Mouse control diagonal up Right
  if(accelCount[1]<-500 && accelCount[0]<-200)
    {
      for(int i=0; i<3; i++)
    {
      irsend.sendSony(0xE94,12);
      delay(40);
    }
    readAccelData(accelCount);
  }

//Mouse control diagonal up Left

  else if(accelCount[1]>200 && accelCount[0]<-200)
  {
    for(int i=0; i<3; i++)
    {
      irsend.sendSony(0xE95,12);
      delay(40);
    }
    readAccelData(accelCount);
  }
  
//Mouse control diagonal down right

  else if(accelCount[1]<-500 && accelCount[0]>100)
  {
    for(int i=0; i<3; i++)
    {
      irsend.sendSony(0xF94,12);
      delay(40);
    }
    readAccelData(accelCount);
  }

//Mouse control diagonal down left  
  else if(accelCount[1]>200 && accelCount[0]>200)
  {
    for(int i=0; i<3; i++)
    {
      irsend.sendSony(0xF95,12);
      delay(40);
    }
    readAccelData(accelCount);
  }
...
//Mouse control---->right1
  else if(accelCount[1]>-700 && accelCount[1]<-300)
  {
    for(int i=0; i<3; i++)
    {
...
//Mouse control---->right2
  else if(accelCount[1]>-1000 && accelCount[1]<-700)
  {
    for(int i=0; i<3; i++)
    {
...
//Mouse control---->left1
  else if(accelCount[1]>100 && accelCount[1]<400)
  {
    for(int i=0; i<3; i++)
    {
      irsend.sendSony(0xB94,12);
      delay(40);
    }
    readAccelData(accelCount);
  }
...
//Mouse control---->left2
  else if(accelCount[1]>400 && accelCount[1]<800)
  {
    for(int i=0; i<3; i++)
    {
      irsend.sendSony(0xB95,12);
      delay(40);
    }
    readAccelData(accelCount);
  }
